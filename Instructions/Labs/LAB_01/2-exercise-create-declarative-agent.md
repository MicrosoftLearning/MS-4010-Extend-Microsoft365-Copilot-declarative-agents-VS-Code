...
lab:
  ...
  module: 'LAB 01: Build a declarative agent for Microsoft 365 Copilot using Visual
    Studio Code'
  description: In this exercise, you will create a declarative agent project from
    a template, update the manifest, upload the agent to Microsoft 365, and test the
