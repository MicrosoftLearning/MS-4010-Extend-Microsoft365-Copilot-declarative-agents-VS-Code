...
lab:
  ...
  description: You want to improve the user experience when working with your declarative
    agent. Specifically, you want the agent to present the data that it receives from
    the API in a rich way.
  duration: 10 minutes
  level: 200
  islab: true
---
