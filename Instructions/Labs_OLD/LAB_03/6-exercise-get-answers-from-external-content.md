...
lab:
  ...
  description: In this exercise, you use Copilot for Microsoft 365 to get answers
    related to using Microsoft Graph. Copilot uses the external content you ingested
    as a reference to provide you with answers.
  duration: 24 minutes
  level: 200
  islab: true
  primarytopics:
