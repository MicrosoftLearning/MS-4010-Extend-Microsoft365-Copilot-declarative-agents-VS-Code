...
lab:
  ...
  description: In this exercise you learn how to enable an external connection for
    inline results, which is required for Copilot for Microsoft 365 to use the external
